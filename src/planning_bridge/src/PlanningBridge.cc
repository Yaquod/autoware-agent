...
PlanningBridge::PlanningBridge(rclcpp::Node::SharedPtr node, grpc::ServerBuilder& builder)
  ...
  velocity_factor_sub_ = node_->create_subscription<autoware_adapi_v1_msgs::msg::VelocityFactorArray>(
  ...
  steering_factor_sub_ = node_->create_subscription<autoware_adapi_v1_msgs::msg::SteeringFactorArray>(
...
void PlanningBridge::onTrajectoryPoint(const autoware_planning_msgs::msg::Trajectory::SharedPtr msg) {
  boost::asio::post(strand_, [this, msg = std::move(msg)]() mutable { onTrajectoryPointImpl(msg); });
...
void PlanningBridge::onTrajectoryLane(const autoware_planning_msgs::msg::Trajectory::SharedPtr msg) {
  boost::asio::post(strand_, [this, msg = std::move(msg)]() mutable { onTrajectoryLaneImpl(msg); });

}

void PlanningBridge::onVelocityFactor(const autoware_adapi_v1_msgs::msg::VelocityFactorArray::SharedPtr msg) {
  boost::asio::post(strand_, [this, msg = std::move(msg)]() mutable { onVelocityFactorImpl(msg); });

}

void PlanningBridge::onSteeringFactor(const autoware_adapi_v1_msgs::msg::SteeringFactorArray::SharedPtr msg) {
...
void PlanningBridge::onScenarioState(const autoware_internal_planning_msgs::msg::Scenario::SharedPtr msg) {
...
void PlanningBridge::onTrajectoryPointImpl(const autoware_planning_msgs::msg::Trajectory::SharedPtr msg) {
  ...
  void PlanningBridge::onFullRouteImpl(const autoware_planning_msgs::msg::LaneletRoute::SharedPtr msg) {
...
void PlanningBridge::onTrajectoryLaneImpl(const autoware_planning_msgs::msg::Trajectory::SharedPtr msg) {
...
void PlanningBridge::onVelocityFactorImpl(const autoware_adapi_v1_msgs::msg::VelocityFactorArray::SharedPtr msg) {
...
void PlanningBridge::onSteeringFactorImpl(const autoware_adapi_v1_msgs::msg::SteeringFactorArray::SharedPtr msg) {
...
void PlanningBridge::onRouteStateImpl(const autoware_adapi_v1_msgs::msg::RouteState::SharedPtr msg) {
  state_.routing_state.set_state(toRouteState(msg->state));
}


void PlanningBridge::onScenarioStateImpl(const autoware_internal_planning_msgs::msg::Scenario::SharedPtr msg) {
